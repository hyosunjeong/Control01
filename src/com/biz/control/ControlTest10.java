...
public class ControlTest10 {
	...
	public static void main(String[] args) {
		...
		System.out.println("3의 배수의 갯수:" + thCount);
		...
		int a=3;
		//정수형 변수 a를 선언하고, clear한 후 3을 저장하라
		
		System.out.println(a);
		// 변수 a에 저장된 값(3)을 console에 보여라
		
		int b =3;
		// 정수형 변수 b를 선언하고, clear한 후 3을 저장하라
		
		System.out.println(a+b);
		// 변수 a에 저장된 값(3)과 변수 b에 저장된 값(4)을 덧셈하여 console에 보여라
